...
% Last Modified by GUIDE v2.5 11-Dec-2020 19:29:47
...
[r,c]=size(A);
totmean3=sum(A(:))/(r*c);
string1 = sprintf('Moyenne Signal = %.3f', totmean3);
...
[r,c]=size(B); 
totmean4=sum(B(:))/(r*c);
string2 = sprintf('Moyenne Bruit = %.3f', totmean4);
set(handles.edit4, 'String', string2);
Resultat2 = totmean3/totmean4;
...
[r,c]=size(A);
totmean5=sum(A(:))/(r*c);
string1 = sprintf('Moyenne Signal = %.3f', totmean5);
...
[r,c]=size(B); 
totmean6=sum(B(:))/(r*c);
string2 = sprintf('Moyenne Bruit = %.3f', totmean6);
set(handles.edit6, 'String', string2);
Resultat3 = totmean5/totmean6;
string3 = sprintf('Signal/Bruit = %.3f',Resultat3);
set(handles.edit9, 'String', string3);
%save Resultat3;

SNR=[Resultat1,Resultat2,Resultat3];
TE=[22,87,164];
axes(handles.axes11);
plot(TE,SNR);
title('SNR=f(TE) pour TR=4000ms');
xlabel('TE(ms)');
ylabel('SNR');
